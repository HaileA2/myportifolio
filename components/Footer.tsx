...
const socialLinks = [
  {
    name: "GitHub",
    href: "https://github.com/HaileA2", // replace with your real URL
    svgPath: (
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/haileabebe", // replace with your real URL
    svgPath: (
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/haileabebe", // replace with your real URL
    svgPath: (
